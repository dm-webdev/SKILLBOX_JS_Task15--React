export default [{
    ...
    "img": "./img/jigsaw.jpg",
    "toolDesc": "Лобзик применяется для короткого и фигурного распила деревянных и металлических поверхностей.",
    // "availability": true,
    "quantity": 10,
    "price": 1500,
    "toolComment": [{
  ...
  },
  {
    ...
    "img": "./img/planer.jpg",
    "toolDesc": "Рубанок электрический — простой удобный электроинструмент для решения различных хозяйственных задач — строгания досок и бруса.",
    // "availability": true,
    "quantity": 5,
    "price": 3100,
    "toolComment": [{
  ...
  },
  {
    ...
    "img": "./img/sander.jpg",
    "toolDesc": "Этот инструмент предназначен для шлифования дерева, окрашенных поверхностей, мягкой  пластмассы  и  металла.",
    // "availability": false,
    "quantity": 0,
    "price": 2500,
    "toolComment": [{
  ...
  },
  {
    ...
    "img": "./img/grinder.jpg",
    "toolDesc": "Подходит для шлифования, очистки и резки различных материалов: дерева, кафеля, камня, кирпича, толстого пластика и металла.",
    // "availability": false,
    "quantity": 0,
    "price": 3215,
    "toolComment": [{
  ...
  },
  {
    ...
    "img": "./img/fraser.jpg",
    "toolDesc": "Фрезер — удобный станок средней мощности для обработки древесины, пластика, цветных металлов, гипсокартона.",
    // "availability": true,
    "quantity": 4,
    "price": 2850,
    "toolComment": [{
